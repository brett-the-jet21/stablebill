    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="px-6 pt-20 pb-16 max-w-6xl mx-auto">
        ...
        <p className="mt-6 text-sm text-white/40 font-medium">
          Non-custodial · SOC2 Compliant Logic · 0% Volatility
        </p>
      </section>

      {/* Trust Bar - CRITICAL FOR CONVERSION */}
      ...
      <section id="features" className="px-6 py-24">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold tracking-tight">Built for modern finance.</h2>
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            <div className="rounded-2xl border border-white/10 p-8 bg-gradient-to-b from-white/[0.02] to-transparent">
              <h3 className="text-xl font-bold mb-3">Tax-Ready Compliance</h3>
              <p className="text-white/60">Generate PDFs and metadata that your accountant actually understands.</p>
            </div>
            <div className="rounded-2xl border border-white/10 p-8 bg-gradient-to-b from-white/[0.02] to-transparent">
              <h3 className="text-xl font-bold mb-3">Instant Global Settlement</h3>
              <p className="text-white/60">Skip the SWIFT network. Move funds across borders in under 60 seconds.</p>
            </div>
            <div className="rounded-2xl border border-white/10 p-8 bg-gradient-to-b from-white/[0.02] to-transparent">
              <h3 className="text-xl font-bold mb-3">Non-Custodial Security</h3>
              <p className="text-white/60">You own your keys. StableBill never touches your private funds.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="px-6 py-24 border-t border-white/10 bg-white/[0.01]">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3 text-left">
            <div className="rounded-3xl border border-white/10 p-8">
              ...
              <Link className="w-full block text-center bg-white/10 text-white px-5 py-3 rounded-xl font-semibold hover:bg-white/20" href="/signup">Start Free</Link>
            </div>
            <div className="rounded-3xl border-2 border-blue-500 p-8 relative">
              ...
              <p className="mt-4 text-white/60 mb-8">Unlimited volume + QuickBooks sync + Priority support.</p>
              <Link className="w-full block text-center bg-blue-500 text-white px-5 py-3 rounded-xl font-semibold hover:opacity-90" href="/signup">Get Pro</Link>
            </div>
            <div className="rounded-3xl border border-white/10 p-8">
              <div className="text-lg font-medium text-white/50">Enterprise</div>
              <div className="mt-4 text-5xl font-bold">Custom</div>
              <p className="mt-4 text-white/60 mb-8">Custom API access and treasury management tools.</p>
              <Link className="w-full block text-center bg-white/10 text-white px-5 py-3 rounded-xl font-semibold hover:bg-white/20" href="/signup">Talk to Sales</Link>
            </div>
          </div>
        </div>
      </section>
